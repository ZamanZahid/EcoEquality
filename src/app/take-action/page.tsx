...
const TakeActionPage: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
            <Head>
                <title>Take Action | EcoEquality</title>
            ...
            <header className="py-16 px-6 md:px-12 lg:px-20 bg-emerald-700 text-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center">
                        ...
                        >
                            Powerful tools and resources to help you advocate for environmental equality in your community
                        </motion.p>
                    </div>
                </div>
            </header>
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                            <div className="px-6 py-8 bg-gradient-to-r from-amber-500 to-amber-600 text-white md:px-10">
                                ...
                                <p className="text-lg opacity-90">
                                    Create personalized letters to send to your representatives about environmental equality issues in your community.
                                </p>
                            </div>
