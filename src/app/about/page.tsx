...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
            <Head>
                <title>About EcoEquality | Environmental Equality and Data Initiative</title>
                <meta name="description" content="Learn about EcoEquality's mission to combat and fix environmental racism through data visualization and community empowerment." />
            ...
            <nav className="px-6 py-4 bg-white shadow-sm md:px-12 lg:px-20">
                <div className="flex items-center justify-between max-w-7xl mx-auto">
                    <div className="flex items-center">
                        <Link href="/">
                            <div className="text-2xl font-bold text-emerald-700 cursor-pointer">
                                Eco<span className="text-gray-800">Equality</span>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="https://github.com/ZamanZahid/EcoEquality" className="text-gray-400 hover:text-emerald-400 transition">
                            ...
                            <div className="md:flex">
                                <div className="md:w-1/2 p-8 md:p-10">
                                    ...
                                    <div className="prose prose-emerald max-w-none text-black">
                                        ...
                                        <p>
                                            Today, residents continue to fight for environmental justice while preserving their unique cultural heritage. Their struggle exemplifies why tools like EcoEquality are necessary to identify patterns of environmental inequality and empower communities to advocate for change.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md overflow-hidden p-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <p className="text-gray-600 mb-4">
                                        EcoEquality uses SVI data as a critical component in identifying communities that may be disproportionately affected by environmental burdens. By overlaying SVI data with environmental hazard information, we can identify patterns of environmental injustice.
                                    </p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <p className="text-emerald-100 pl-11">
                                                Use EcoEquality and other resources to understand the environmental conditions in your community. Knowledge is the first step toward meaningful action.
                                            </p>
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-emerald-100 pl-11">
                                                Create reports using data from EcoEquality to support your advocacy. Data-driven arguments can be powerful tools for change.
                                            </p>
                                        </div>
                                    </div>
                                </div>
