...
export function createLetterPrompt(formData: FormData, recipient: Recipient): string {
    ...
    return `
  You are an environmental equality advocate assisting community members in crafting effective letters to government officials. Write a formal, persuasive, respectful letter to ${recipient.title} ${recipient.name} about an environmental justice concern. Use these specific details:
  ...
  - Focus on environmental equality principles, emphasizing that all communities deserve equal protection from environmental hazards
