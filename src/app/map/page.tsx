...
export default function MapPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
            <Head>
                <title>Interactive Map | EcoEquality</title>
                <meta name="description" content="Explore environmental equality, data and identify patterns of environmental racism across communities." />
            ...
            <header className="py-12 px-6 md:px-12 lg:px-20 bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Environmental Equality Map</h1>
            ...
            <main className="py-12 px-6 md:px-12 lg:px-20">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        >
                            <h2 className="text-2xl font-bold text-gray-900 mb-4">Understanding Environmental Equality and Justice</h2>
                            <p className="text-gray-600 mb-4">
                                Environmental Equality is the fair treatment and meaningful involvement of all people regardless of race, color, national origin, or income with respect to the development, implementation, and enforcement of environmental laws, regulations, and policies.
                            </p>
                            <p className="text-gray-600 mb-4">
                        ...
                        >
                            <div className="p-6 bg-emerald-700 text-white">
                                ...
                                <p className="text-emerald-100">Additional information to help you understand and use our environmental equality and justice data</p>
                            </div>
                            <div className="p-6 space-y-4">
                                ...
                                <a href="/take-action" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    ...
                                    <p className="text-gray-600 text-sm">Step-by-step guide to advocating for environmental equality in your community</p>
                                </a>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                        <div className="col-span-1 md:col-span-2">
                            <div className="text-2xl font-bold mb-4">
                                Eco<span className="text-emerald-400">Equality</span>
                            </div>
