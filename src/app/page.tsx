...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      <Head>
        <title>EcoEquality | Exposing Environmental Inequality</title>
        <meta name="description" content="EcoEquality uses EPA, CDC, Census Bureau data to visualize and combat environmental racism across the United States." />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Environmental Equality <span className="text-emerald-600">For All</span>
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                About <span className="text-emerald-600">EcoEquality</span>
              </h2>
              <p className="text-gray-600">
                EcoEquality is more than just an app—it&apos;s a movement toward environmental equity. We gather and analyze data from the EPA, CDC, and Census Bureau to reveal patterns of environmental racism across the United States.
              </p>
              <p className="text-gray-600">
